...
src_configure() {
	...
	EXTENSIONS="default"
#./configure --enable-application=browser --disable-dbus --enable-default-toolkit=cairo-gtk2 --disable-jemalloc --disable-crashreporter --with-system-nss --with-system-nspr --disable-tests
