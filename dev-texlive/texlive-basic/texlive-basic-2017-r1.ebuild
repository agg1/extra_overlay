...
TEXLIVE_MODULE_CONTENTS="amsfonts bibtex cm enctex etex etex-pkg graphics-def hyph-utf8 ifluatex ifxetex knuth-lib knuth-local lua-alt-getopt makeindex metafont mflogo mfware pdftex plain tex tex-ini-files texlive-common texlive-docindex texlive-en texlive-msg-translations texlive-scripts unicode-data updmap-map collection-basic
"
